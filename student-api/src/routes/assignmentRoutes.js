...
const { createAssignment, getAssignmentsByCourse, getAssignmentById, submitAssignment, gradeSubmission, getPendingSubmissions } = require("../controllers/assignmentController");
...
router.get("/lecturer/pending", protect, authorize("lecturer", "admin"), getPendingSubmissions);
